...
(function() {
  var loadGoogleMapsScript, startSpinner, stopSpinner;

  Turbolinks.enableTransitionCache();

  startSpinner = function() {
    return $('.loading-overlay').fadeIn('fast');
  };
  ...
  window.initializeMap = function() {
    var center, map, mapOptions, marker;
  ...
  $(document).ready(function() {
    ...
    if ($('#map-canvas').length > 0) {
      ...
      $('#servicios .background').on('mouseenter', function() {
        return $('.overlay', this).fadeIn(500);
      });
      $('#servicios .background').on('mouseleave', function() {
        return $('.overlay', this).fadeOut(500);
      });
    } else {
      $('#navbar a').each(function(i, a) {
        ...
        if (data != null) {
          return $(a).attr('href', data).attr('data-href', href);
        }
      });
    }
    if (window.location.pathname.indexOf('service') >= 1) {
      ...
      return $('div.foto').addClass(active);
    }
  });
